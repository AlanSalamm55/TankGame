...
IMovable	Move(Vector2 direction)	

Defines translation and rotation logic.
IHealth	TakeDamage(int amount), Heal(int amount)	

Manages health changes for any object.
IShooter	Shoot()	

Handles projectile instantiation.
IEnemy	Attack()	

Defines basic enemy offensive behavior.
